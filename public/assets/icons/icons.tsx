...
export const RedStick = ({ className }: Props) => {
  <svg
...
export const BlueStick = ({ className }: Props) => {
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="6"
    height="72"
...
export const GreenStick = ({ className }: Props) => {
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="6"
    height="72"
...
export const RedCheck = ({ className }: Props) => {
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="20.433"
    height="20.433"
...
export const GreenCheck = ({ className }: Props) => {
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="27.022"
    height="26.534"
...
export const CheckIcon = ({ className }: Props) => (
  ...
  >
    <g
      ...
      transform="translate(0.369 0.496)"
    >
      <circle
        id="Ellipse_336"
      ...
      <g
        id="Icon_feather-plus"
        data-name="Icon feather-plus"
        transform="translate(13.612 3.504) rotate(45)"
      >
        <path
          id="Path_140"
          data-name="Path 140"
          d="M0,0V14.114"
          transform="translate(7.057)"
          fill="none"
          stroke="#fff"
          stroke-linecap="round"
          stroke-linejoin="round"
